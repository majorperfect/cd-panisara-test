...
func request_CodeAnalyzerService_AnalyzeUploader_0(ctx context.Context, marshaler runtime.Marshaler, client CodeAnalyzerServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var metadata runtime.ServerMetadata
...
var (
	filter_CodeAnalyzerService_FileUpload_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_CodeAnalyzerService_FileUpload_0(ctx context.Context, marshaler runtime.Marshaler, client CodeAnalyzerServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_CodeAnalyzerService_FileUpload_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.FileUpload(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_CodeAnalyzerService_FileUpload_0(ctx context.Context, marshaler runtime.Marshaler, server CodeAnalyzerServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq FileUploadRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.FileUpload(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterCodeAnalyzerServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CodeAnalyzerServiceServer) error {
	...
	mux.Handle("GET", pattern_CodeAnalyzerService_AnalyzeUploader_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
	...
	mux.Handle("GET", pattern_CodeAnalyzerService_FileUpload_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/codeanalyzer.CodeAnalyzerService/FileUpload", runtime.WithHTTPPathPattern("/api/code-analyzer/upload/file"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_CodeAnalyzerService_FileUpload_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_CodeAnalyzerService_FileUpload_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterCodeAnalyzerServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CodeAnalyzerServiceClient) error {
	...
	mux.Handle("GET", pattern_CodeAnalyzerService_AnalyzeUploader_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/codeanalyzer.CodeAnalyzerService/AnalyzeUploader", runtime.WithHTTPPathPattern("/api/code-analyzer/upload"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_CodeAnalyzerService_AnalyzeUploader_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_CodeAnalyzerService_AnalyzeUploader_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_CodeAnalyzerService_FileUpload_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/codeanalyzer.CodeAnalyzerService/FileUpload", runtime.WithHTTPPathPattern("/api/code-analyzer/upload/file"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_CodeAnalyzerService_FileUpload_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_CodeAnalyzerService_AnalyzeUploader_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "code-analyzer", "upload"}, ""))

	pattern_CodeAnalyzerService_FileUpload_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "code-analyzer", "upload", "file"}, ""))
)

var (
	forward_CodeAnalyzerService_HealthCheck_0 = runtime.ForwardResponseMessage

	forward_CodeAnalyzerService_AnalyzeUploader_0 = runtime.ForwardResponseMessage

	forward_CodeAnalyzerService_FileUpload_0 = runtime.ForwardResponseMessage
)
